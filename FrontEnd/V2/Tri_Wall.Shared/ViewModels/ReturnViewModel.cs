...
public partial class ReturnViewModel(ApiService apiService, ILoadMasterData loadMasterData) : ViewModelBase
{
    ...
    [ObservableProperty] ObservableCollection<GetBatchOrSerial> _getBatchOrSerialReturns = new();
    ...
    async Task OnGetGoodReceiptPoHeaderDeatialByDocNum(string docEntry)
    {
        ...
        GetBatchOrSerialReturns = (await apiService.GetBatchOrSerial(docEntry, "GetBatchSerialReturn")).Data ?? new();
    }
